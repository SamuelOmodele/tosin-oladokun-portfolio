...
export const Hero: FC = () => {
  return (
    <section
      className="flex w-full flex-col-reverse md:flex-row items-center justify-between pt-4 md:pt-20 gap-4 md:min-h-screen px-2 md:px-0"
      id="home"
    >
          ...
          <div>
            ...
            <p className="text-lg md:mt-4 md:text-xl lg:text-2xl font-light leading-relaxed text-neutral-900 dark:text-neutral-100 md:flex-2/3">
              ...
              <RoughNotation
                ...
                multiline
              >
                Bloc state management, Firebase integration, API development, and local database management.
              </RoughNotation>
              {" "} I’m committed to continuous learning,
              clean architecture, and delivering innovative solutions that enhance user experience.
              {/* <RoughNotation
                type="bracket"
              ...
              >
               ...
               {" "} Got an organization that needs someone like me?{" "}
              <RoughNotation
                type="underline"
                color="var(--primary)"
                order="6"
      ...
      <Image
        ...
        width={300}
        height={300}
        className="size-[90%] md:size-[300px] mb-4 p-4 md:p-5 md:m-10 border-2 border-neutral-200 dark:border-neutral-200/20 shadow-lg shadow-neutral-200/50 dark:shadow-neutral-200/10 hover:shadow-neutral-300/50 dark:hover:shadow-neutral-200/20 transition-all duration-200 mt-10 md:mt-0"
        priority
      />
    </section>
  );
